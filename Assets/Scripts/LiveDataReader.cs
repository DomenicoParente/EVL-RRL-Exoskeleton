// Handles the conection with Vicon system in order to retrieve data of motion capture in realtime.
using System;
...
public class LiveDataReader : MonoBehaviour
{
    ...
    // This method tries to connect to the given IP, if it is successful it get information from Vicon system and creates the points
    // otherwise it throw an error message.
    ...
    //This method get the names of the points from Vicon system and creates a list
